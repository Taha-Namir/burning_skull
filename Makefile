...
ifeq ($(OS), linux)
	OSFLAGS += -Lmlx_linux -lmlx_Linux -L/usr/lib -Imlx_linux -lXext -lX11 -lm -lz
else
	OSFLAGS += -Lmlx -lmlx -framework OpenGL -framework AppKit
endif
...
$(NAME) : mlx $(SRC) $(HEADER)
	@cc $(SRC) $(OSFLAGS) -Wall -Wextra -Werror -o $(NAME)
